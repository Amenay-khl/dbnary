...
import { BarChart, Bar, XAxis, YAxis, Tooltip, Legend, Label, AreaChart, Area } from "recharts";
...
const BarGraph = ({ title, data, labels }) => {
    ...
    return (
        <div>
            <h3>{title}</h3>
            <AreaChart width={600} height={300} data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
