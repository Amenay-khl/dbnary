 ...
 */
class NumberOfElementsForFr {
    use UtilsProvider;
 
    const COMPONENT_ID = DBNARY_DASHBOARD_SLUG . '-numberOfElementsForFr'; // attribute ID
    ...
    public static function instance() {
        return new NumberOfElementsForFr();
    }
}
