 ...
 */
class NumberOfTranslationsForFr {
    use UtilsProvider;
 
    const COMPONENT_ID = DBNARY_DASHBOARD_SLUG . '-numberOfTranslationsForFr'; // attribute ID
    ...
    public static function instance() {
        return new NumberOfTranslationsForFr();
    }
}
