 ...
 */
class NumberOfLexicalRelationsForFr {
    use UtilsProvider;
 
    const COMPONENT_ID = DBNARY_DASHBOARD_SLUG . '-numberOfLexicalRelationsForFr'; // attribute ID
    ...
    public static function instance() {
        return new NumberOfLexicalRelationsForFr();
    }
}
