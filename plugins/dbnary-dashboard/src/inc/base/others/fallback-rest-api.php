...
if (!function_exists('dbnary_dashboard_skip_rest_admin_notice')) {
    /**
     ...
     */
    function dbnary_dashboard_skip_rest_admin_notice() {
...
add_action('admin_notices', 'dbnary_dashboard_skip_rest_admin_notice');
